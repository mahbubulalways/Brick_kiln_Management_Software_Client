...
const AdvanceInvoicePage = () => {
  ...
  const advanceInvoices = totalInvoices?.filter(
    (invoice: IChallanForDataShow) => invoice.chalanType === "অগ্রিম চালান"
  );
  const filtered = advanceInvoices.filter((row: IChallanForDataShow) =>
