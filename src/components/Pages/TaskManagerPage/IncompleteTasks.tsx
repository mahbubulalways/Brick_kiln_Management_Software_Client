    ...
    return (
      <section>
        ...
        <div className="rounded-lg border border-gray-200 py-12 text-center text-sm text-red-500">
          অসম্পূর্ণ কাজ লোড করতে সমস্যা হয়েছে।
        </div>
      </section>
    );
  }
                  ...
                  <td className="px-3 py-3">
                    <div className="flex items-center gap-3">
                      <button
                        ...
                        className="flex h-5 w-5 items-center justify-center rounded border border-gray-300 bg-white transition hover:border-[#039a63]"
                      >
