                ...
                >
                  ...
                  <td className="px-3 py-2.5 sm:py-3">
                    <input
                      ...
                      readOnly
                      className="max-w-[190px] rounded-lg border border-gray-300 px-3 py-1.5 text-[13px] outline-none sm:py-2 sm:text-sm"
                    />
                  </td>
                  ...
                  <td className="px-3 py-2.5 sm:py-3">
                    <div className="flex justify-center gap-1.5 sm:gap-2">
                      <button
                        ...
                        className="flex h-8 w-8 items-center justify-center rounded-lg bg-[#dcfce9] text-[#039a63] hover:bg-[#c9f7dc] sm:h-9 sm:w-9"
                      >
                      ...
                      <button
                        ...
                        className="flex h-8 w-8 items-center justify-center rounded-lg bg-[#ffe1e5] text-[#ff3b30] hover:bg-[#ffd3d8] sm:h-9 sm:w-9"
                      >
