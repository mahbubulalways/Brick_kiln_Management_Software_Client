...
const ChalanPrintModal = ({ isOpen, onClose }: TCustomModal) => {
            ...
            <div id="chalan">
              <div className="flex justify-between items-start mt-2">
                ...
                <div>
                  ...
                  <p className="text-sm">
                    চালানের তারিখঃ{" "}
                    <span className="font-semibold">৩১-১০-২০২৫</span>
                  </p>
                </div>
              </div>
              ...
              <div className="flex justify-between mt-4 gap-3">
                {/* Left Red Logo */}
                <div className="flex justify-center items-center border border-red-500 rounded text-red-600 text-3xl px-4 rotate">
                  <p className="-rotate-90"> বাকি</p>
                </div>
                ...
                <div className="flex-1 border border-gray-200 rounded p-2">
                  <div className="grid grid-cols-2 gap-2">
                    <div className="bg-gray-50 rounded p-2 text-center">
                      ...
                      <p className="font-semibold">৳ ১০,৫০০</p>
                    </div>
                    <div className="bg-orange-50 rounded p-2 text-center">
                      <p className="text-gray-600 text-xs">ছাড়</p>
                      <p className="font-semibold text-orange-600">৳ ২০০</p>
                    </div>
                    <div className="bg-blue-50 rounded p-2 text-center">
                      <p className="text-gray-600 text-xs">গাড়ি ভাড়া</p>
                      <p className="font-semibold text-blue-600">৳ ৫০০</p>
                    </div>
                    <div className="bg-green-50 rounded p-2 text-center">
                      <p className="text-gray-600 text-xs">সর্বমোট</p>
                      <p className="font-semibold text-green-600">৳ ১০,০০০</p>
                    </div>
                    <div className="bg-gray-50 rounded p-2 text-center">
                      <p className="text-gray-600 text-xs">জমা</p>
                      <p className="font-semibold">৳ ৫,০০০</p>
                    </div>
                    <div className="bg-red-50 rounded p-2 text-center">
                      <p className="text-gray-600 text-xs">বাকি</p>
                      <p className="font-semibold text-red-600">৳ ৫,০০০</p>
                    </div>
                  </div>
              ...
              <div className="text-center mt-6 text-[12px] text-gray-700">
                ...
                <p className="text-[10px] text-gray-500 mt-4">
                  Powered by - PAYRA TECH • ০১৯১৯৮৯৮৭০
                </p>
              </div>
            </div>
            <div id="chalan2"></div>
